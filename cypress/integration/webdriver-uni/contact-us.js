...
describe("Test contact us form via webdriverUni", () => {
  ...
  it("Should be able to submit a successful submision via contact us form", () => {
    ...
    contact_us.contactForm_Submission(data.first_name, data.last_name, data.email, data.body, '#contact_reply', "Thank You for your Message2!")
  });

  it("Should not be able to submit a successful submision via contact us form as all fields are required", () => {
    contact_us.contactForm_Submission(data.first_name, data.last_name, " ", data.body, 'body', "Error: Invalid email address")
  });
});
